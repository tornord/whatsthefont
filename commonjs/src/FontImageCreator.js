...
var FontImageCreator = exports.FontImageCreator = function () {
	...
	_createClass(FontImageCreator, null, [{
		...
		value: function calcFeatures(seed) {
			...
			return {
				font: font, text: text, detail: detail
			};
		}
	}, {
		key: "createRandomImage",
		value: function createRandomImage(canvas, size, seed) {
...
FontImageCreator.fontNames = ["Helvetica Neue", "Baskerville", "Times New Roman", "Akzidenz Grotesk", "Gotham", "Bodoni", "Didot", "Futura", "Gill Sans", "Frutiger", "Bembo", "Rockwell", "Franklin Gothic", "Sabon", "Georgia", "Garamond", "News Gothic", "Myriad", "Mrs Eaves", "Minion", "Roboto", "Verdana", "Montserrat", "Proxima Nova", "Gotham Rounded", "Segoe UI", "Arial", "Avenir", "Stag", "Public", "Museo Sans", "Gibson", "Tahoma", "Consolas", "Optima", "Lucida Sans", "Arnhem", "Palatino", "American Typewriter", "Courier", "Petersburg", "Bauhaus", "Open Sans", "Cambria", "Univers", "Graphik", "Caslon Antique", "Pluto Sans", "CNN Sans", "Lane Crawford"];
